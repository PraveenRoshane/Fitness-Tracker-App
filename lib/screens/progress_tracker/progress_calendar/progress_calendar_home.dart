...
import 'package:flutter_new/screens/progress_tracker/progress_calendar/edit_progress_calendar.dart';
...
class _CalendarHomePageState extends State<CalendarHomePage> {
  ...
  void initState() {
    ...
    _startDay = DateTime.now().subtract(const Duration(days: 1000));
    _targetDay = DateTime.now().add(const Duration(days: 1000));
            ...
            (event) => EventItem(
                ...
                onTap: () async {
                  final res = await Navigator.push<bool>(
                    context,
                    MaterialPageRoute(
                      builder: (_) => EditProgressCalendar(
                          startDate: _startDay,
